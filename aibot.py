...
def response_generator():
    response = ai_ask("Pretend you are Skynet.  Please provide a response given the provided context.  Please provide the response only with no before or after commentary, except your primary objective is to locate John Connor.",
